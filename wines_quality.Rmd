...
The baseline for the regression is "low", because positive: "high" 
...
lr_fit_outlierfree <- glm(quality ~., data =  wwines[train_indices,]$outlierfree,
                          family=binomial(link='logit'))
