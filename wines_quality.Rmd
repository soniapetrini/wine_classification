...
task_train = TaskClassif$new(id = "wines",  dtrain, target = "quality", positive = "high")
...
```{r}
task_train = TaskClassif$new(id = "wines",  dtrain.res, target = "quality", positive = "high")
task_test = TaskClassif$new(id = "wines_test",  dtest.res, target = "quality", positive = "high")
...
restr_probs <- predict(lr_fit_res,  dtest.res, type="response")
...
plot(lr_fit_of_1, which = 4, id.n = 1)
```
